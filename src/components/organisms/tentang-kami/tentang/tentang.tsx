  ...
  return (
    <section className="relative w-full pt-20 pb-0">
      ...
      <div className="relative z-10 rounded-t-xl bg-primary px-6 pt-24 pb-16 text-white md:rounded-t-4xl md:px-12 lg:px-[150px]">
        <div className="flex flex-col items-center justify-center gap-12 md:gap-16 lg:flex-row lg:gap-24">
          <motion.div
            initial={{ x: -50, opacity: 0 }}
            whileInView={{ x: 0, opacity: 1 }}
            transition={{ duration: 0.7 }}
            className="relative h-[300px] w-full rounded-sm md:h-[400px] lg:h-[500px]"
          >
            <Image
              src={ABOUT_DATA.image}
              alt="Ilustrasi Food Waste"
              fill
              className="w-full rounded-2xl object-cover grayscale transition-all duration-700 ease-in-out hover:grayscale-0"
            />
          </motion.div>
